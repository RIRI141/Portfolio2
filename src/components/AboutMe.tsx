    ...
    <div className="px-4 sm:px-6 pt-6 mt-[69px]">
      ...
      <div className="md:hidden">
        <div className="flex justify-center gap-4 mb-6">
          ...
          <div className="relative">
            <div className={`transition-all duration-500 ${
              isChasing ? 'translate-x-4 opacity-100 shake-horizontal' : 'translate-x-0 opacity-0 absolute'
            }`}>
              <Image
                src="/assets/img/Hero/RunningMan.png"
                alt="Running character"
        ...
        <div className="flex flex-col justify-center items-center text-center text-white">
          <h1 className="mb-4 font-bold text-2xl sm:text-3xl drop-shadow-lg">Hello, I'm Ryoga</h1>
